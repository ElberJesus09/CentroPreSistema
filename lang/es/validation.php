...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute aparece en una filtración de datos. Elige otro valor.',
    ],
    ...
    'attributes' => [
        ...
        'floor' => 'piso',
        'capacity' => 'capacidad',
        'academic_priority' => 'orden de distribución',
        ...
        'student.mother_last_name' => 'apellido materno del estudiante',
        'student.dni' => 'DNI del estudiante',
        'student.birth_date' => 'fecha de nacimiento del estudiante',
        'student.gender' => 'género del estudiante',
        'student.phone' => 'celular del estudiante',
        'student.address' => 'dirección del estudiante',
        'student.email' => 'correo electrónico del estudiante',
        'student.payment_voucher_number' => 'número de voucher',
        'student.payment_agency_number' => 'número de agencia',
        'student.payment_date' => 'fecha de pago',

        'guardian.first_name' => 'nombres del apoderado',
        'guardian.last_name' => 'apellido paterno del apoderado',
        'guardian.mother_last_name' => 'apellido materno del apoderado',
        'guardian.dni' => 'DNI del apoderado',
        'guardian.phone' => 'celular del apoderado',
        'guardian.relationship' => 'parentesco',

        'school.name' => 'institución educativa',
        'school.department' => 'departamento del colegio',
        'school.province' => 'provincia del colegio',
        'school.district' => 'distrito del colegio',
        'school.graduation_year' => 'año de egreso',
    ],
];
